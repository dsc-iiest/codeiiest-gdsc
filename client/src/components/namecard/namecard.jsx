...
function NamecardMini({ name, post, profilepic }) {
    return (
...
function NamecardHorizontal({ profilepic, name, codeiiest, gdsc, descrip }) {
    return (
        <div className="namecard-horz">
...
function NamecardVertical({ profilepic, name, codeiiest, gdsc, descrip }) {
    name = name.split(" ")
    return (
